...
export default function Page() {
  ...
  const [remententeAdd, setRemententeAdd] = useState<string>(
    "AVENIDA AUGUSTO DOS ANJOS, 489\nCAIXA POSTAL 2813 - PARANGABA\nFORTALEZA - CE 60720-971"
  );
  ...
  const handleEtiquetas = useCallback(
    ...
    [rementente, refEtiquetas, refInitialEtiquetas, remententeAdd]
  );
          ...
          <div className="h-full">
            ...
            <div className="w-full mt-4">
              ...
              <Input
                ...
                value={remententeAdd}
                onChange={(e) => setRemententeAdd(e.target.value)}
              />
            </div>
